...
|     | **[Bugs](todo/bugs.md)**                                                                                                                                                    |             |             |
| B334 | [The Blade view roots never notice a `resources/views` created later](todo/bugs.md#b334-the-blade-view-roots-never-notice-a-resourcesviews-created-later)                    | Low         | Low         |
