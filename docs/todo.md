...
| B1   | [The Pint formatting proxy inherits the server's working directory](todo/bugs.md#b1-the-pint-formatting-proxy-inherits-the-servers-working-directory) (gates BL16 short term) | Medium     | Low        |
