...
| B114 | [`Mockery::mock()` / `$this->mock()` drop the intersection with the mocked class](todo/bugs.md#b114-mockerymock--thismock-drop-the-intersection-with-the-mocked-class) | Medium      | Low-Medium  |
