...
| B359 | [Go-to-definition for a config/trans key misses an escaped declaration](todo/bugs.md#b359-go-to-definition-for-a-configtrans-key-misses-an-escaped-declaration)            | Low         | Low         |
